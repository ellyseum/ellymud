...
- Your research covers 10+ files with detailed analysis
- You've previously hit "response length limit" errors
- The investigation scope is large (multi-system feature)
- You're documenting complex inter-module relationships
...
create_file(
  path: ".github/agents/research/research_TOPIC_TIMESTAMP.md",
  content: "# Research Document: [Topic]\n\n## 1. Objective\n...[first 2-3 sections]..."
)
```
...
read_file(path: ".github/agents/research/research_TOPIC_TIMESTAMP.md", startLine: 1, endLine: 50)
```
...
### Example: Large Research Document in Chunks

**Chunk 1** (create_file):
- Header, Objective, Entities Identified, Current State
- ~150-200 lines

**Chunk 2** (replace_string_in_file):
- Detailed Code Analysis for modules 1-3
- ~150-200 lines

**Chunk 3** (replace_string_in_file):
- Detailed Code Analysis for modules 4-6, Gap Analysis
- ~150-200 lines

**Chunk 4** (replace_string_in_file):
- Implementation Guidance, Test Scenarios, Recommendations
- ~100-150 lines
