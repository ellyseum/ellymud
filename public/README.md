...
The `admin/` subdirectory contains the built React admin interface. 

> ⚠️ **The admin interface source code is in [`admin-ui/`](../admin-ui/).**
> Files in `admin/` are generated by `npm run admin:build`. Do not edit directly.

See [admin/README.md](admin/README.md) for details about the admin dashboard features.
