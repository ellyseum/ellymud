...
/**
 * Helper function to create a mock CombatEntity
 */
function createMockCombatEntity(overrides: Partial<CombatEntity> = {}): CombatEntity {
  return {
    name: 'TestEntity',
    health: 100,
    maxHealth: 100,
    ...
    getAttackText: jest.fn().mockReturnValue('attacks'),
    ...
    getName: jest.fn().mockReturnValue('TestEntity'),
    ...overrides,
  };
}

/**
 * Helper function to create a mock ConnectedClient
 */
function createMockConnectedClient(overrides: Partial<ConnectedClient> = {}): ConnectedClient {
  return {
    id: 'test-client-id',
    connection: {
      write: jest.fn(),
...
describe('CombatState', () => {
  ...
  describe('ActiveCombatState', () => {
    ...
    describe('handleMovement', () => {
      it('should delegate to onMovementCallback', () => {
        const client = createMockConnectedClient();
      ...
      it('should pass the correct client to callback', () => {
        const client = createMockConnectedClient({ id: 'unique-client-123' });
    ...
    describe('handleDisconnect', () => {
      ...
      it('should pass the correct client to callback', () => {
        const client = createMockConnectedClient({ id: 'disconnect-client' });
  ...
  describe('FleeingCombatState', () => {
    ...
    describe('handleMovement', () => {
      ...
      it('should always call movement callback (guaranteed break chance)', () => {
        const client = createMockConnectedClient({ id: 'fleeing-mover' });
  ...
  describe('UnconsciousCombatState', () => {
    ...
    describe('handleMovement', () => {
      ...
      it('should be a no-op for any client', () => {
        const client1 = createMockConnectedClient({ id: 'client1' });
        const client2 = createMockConnectedClient({ id: 'client2' });
    ...
    describe('handleDisconnect', () => {
      ...
      it('should allow disconnect even while unconscious', () => {
        const client = createMockConnectedClient({ id: 'unconscious-disconnect' });
  ...
  describe('State Comparison', () => {
    ...
    describe('movement behavior differences', () => {
      ...
      beforeEach(() => {
        client = createMockConnectedClient();
      });
